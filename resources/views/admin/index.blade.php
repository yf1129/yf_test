...
{{--    <script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>--}}
    ...
    <!-- Custom CSS -->
    <link href="{{ asset('css/admin/index/style.css') }}" rel='stylesheet' type='text/css' />
    <!-- Graph CSS -->
    <link href="{{ asset('css/admin/index/lines.css') }}" rel='stylesheet' type='text/css' />
...
{{--    <script src="http://www.jq22.com/jquery/jquery-1.10.2.js"></script>--}}
    ...
    <!---//webfonts--->
    <!-- Nav CSS -->
    <link href="{{ asset('css/admin/index/custom.css') }}" rel="stylesheet">
    <!-- Metis Menu Plugin JavaScript -->
    <script src="{{ asset('js/admin/index/metisMenu.min.js') }}"></script>
    <script src="{{ asset('js/admin/index/custom.js') }}"></script>
    <!-- Graph JavaScript -->
    <script src="{{ asset('js/admin/index/d3.v3.js') }}"></script>
    <script src="{{ asset('js/admin/index/rickshaw.js') }}"></script>
</head>
<body>
<div id="wrapper">
    <!-- Navigation -->
